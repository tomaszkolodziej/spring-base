...
public class DictionaryRestController {
  ...
  public DictionaryViewDto updateDictionaryItem(@PathVariable String code, @PathVariable Long itemId, @RequestBody DictionaryItemUpdateDto dictionaryItemUpdateDto) {
